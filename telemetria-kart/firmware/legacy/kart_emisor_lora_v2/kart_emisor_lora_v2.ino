// =====================================================================
// kart_emisor_lora_v2.ino — KART: BMI160 + Kalman + LoRa (versión revisada)
//
// Cambios respecto a kart_emisor_lora_bmi160_kalman.ino:
//  1. LoRa.endPacket(true) NO bloqueante: antes cada envío congelaba el
//     loop ~150 ms (el paquete tarda eso en el aire a SF7) y el Kalman
//     perdía ~15 muestras por ciclo. Ahora el radio transmite solo.
//  2. Calibración definitiva de la prueba de seis posiciones:
//     offsets actualizados + corrección de SENSIBILIDAD por eje (faltaba).
//  3. GYR_LSB_PER_DPS = 32.768 (32768/1000; antes 32.8, error 0.1 %).
//  4. MODO_LAB: interruptor que saca el CSV de 100 Hz por serial para
//     usar las herramientas de validación (comparar_kalman.py,
//     estadistica_reposo.py, capturar_serial.py) con este mismo firmware.
//     En el kart: false. En el banco de pruebas: true (y DEBUG_SERIAL false).
// =====================================================================
