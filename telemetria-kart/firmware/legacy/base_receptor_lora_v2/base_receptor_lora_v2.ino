// =====================================================================
// base_receptor_lora_v2.ino — BASE: receptor LoRa -> USB serial (revisado)
//
// Cambios respecto a base_receptor_lora_serial.ino:
//  1. Detección de reinicio del emisor: si seq retrocede (el kart se
//     reinició), los contadores de pérdida se resetean en vez de quedar
//     desfasados.
//  2. Guard adicional en el parseo del seq.
// Salida serial (115200) compatible con Node-RED y puente_serial_mqtt.py:
...
void loop() {
  ...
  if (packetSize) {
    ...
    // CAMBIO: si seq retrocede, el emisor se reinició -> resetear conteo
